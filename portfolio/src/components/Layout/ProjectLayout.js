        ...
        <section className=" my-8">
            <div className="grid grid-cols-5 grid-rows-4 h-full">
                ...
                <div className="lg:col-span-3 lg:row-span-2">
                    <div className={`border ${isDarkMode ? 'border-white' : 'border-black'} relative h-full pb-4 md:pb-0`}>
                        {/* Title Animation */}
                        <motion.div
                            initial={{ width: 0 }}
                ...
                <Link
                    to={link}
                    className="lg:col-span-2 lg:row-span-4 lg:col-start-4 aspect-square transform transition-transform duration-300  h-full w-full"
                >
                    {/* Box with Arrow */}
                    <div
                ...
                <div className=" lg:col-span-2 lg:row-span-2 lg:row-start-3">
                    <div className={`border ${isDarkMode ? 'border-white' : 'border-black'} p-4 md:px-12 flex items-start justify-center h-full`}>
                        <div className="max-md:py-6">
                            ...
                            <motion.p
                                id="summary"
                                className={`py-8 text-${isDarkMode ? 'gray-300' : 'black'}`}
