          ...
          <div className="flex md:justify-center items-center md:items-end">
            <motion.div className="flex flex-col items-center md:items-start justify-center pb-9 md:pb-0">
              <h1
                ...
                } font-bold text-6xl md:text-7xl xl:text-9xl leading-tight`}
              >
                <motion.span
          ...
          <div className="flex justify-center items-end md:justify-start md:items-end md:mt-0">
            <div className="w-full md:w-10/12">
              <motion.p
                ...
                transition={isMobile ? undefined : { duration: 0.6, ease: "easeOut", delay: 0.7 }}
              >
                Welcome, I’m Erik, a product designer based in Denver. I’m passionate
                about creating digital products that are easy to use and enjoyable to
                interact with. I roll up my sleeves to design and code, making sure
                every detail supports a great user experience. Whether working on the
                design or the development side, I focus on building solutions that truly
                work.
                <br />
