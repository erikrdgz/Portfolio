...
import resume from "../assets/Erik_Rodriguez_Resume_2025.pdf";
            ...
            <LiquidGlass className="relative z-10 container mx-auto px-4 py-4 rounded-3xl">
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    >
                        ...
                        <p className={`${isDarkMode ? "text-neutral-200" : "text-neutral-700"} my-4 text-md md:text-md`}>


                            Hey, I'm Erik! I'm a product designer from Chicago, IL, currently living in Denver, CO. I've always been both a tech nerd and an art kid, and I knew I wanted to bridge the two together. That passion led me to Denver, where I pursued my dream. I started my journey at the Art Institute of Colorado pursuing a bachelors in graphic and web design. After completing that I continued my journey as a software engineer through the first U.S. Department of Labor-sponsored Software Engineering program at Techtonic Academy. I was trained in full-stack development, but over the years, I gravitated toward the front-end side, allowing me to merge my technical skills with my design expertise.
                        </p>
                        <p className={`${isDarkMode ? "text-neutral-200" : "text-neutral-700"} my-4 text-md md:text-md`}>
