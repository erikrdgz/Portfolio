...
const About = () => {
    ...
    return (
        <section className={`${isDarkMode ? " text-white" : " text-black"} transition-colors duration-500 pt-20 py-12 md:pt-24 p-8 flex flex-col items-center bg-bottom bg-cover bg-no-repeat`}
         style={{
          backgroundImage: `url(${isDarkMode ? sand : sandLight})`,
          backgroundAttachment: "fixed",
        }}
        >
            <div className="relative z-10 container mx-auto px-4 py-12 glass-card rounded-xl">
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    ...
                    >
                        ...
                        <p className={`${isDarkMode ? "text-neutral-200" : "text-neutral-700"} my-4 text-sm md:text-md`}>
